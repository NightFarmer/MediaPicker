...
import com.nightfarmer.mediapicker.imageloader.mediapicker.CropListener;
...
import com.nightfarmer.mediapicker.imageloader.mediapicker.utils.MessageUtils;
import com.nightfarmer.mediapicker.imageloader.mediapicker.utils.RecursiveFileObserver;
...
public class MediaPickerActivity extends AppCompatActivity implements
    ...
    @Override
    public MediaImageLoaderImpl getImageLoader() {
        return MediaImageLoaderImpl.getInstance(getApplicationContext());
    }
